...
<script type="text/javascript" src="js/sys/orgInfo.js"></script>
...
<body>
	...
	<table id="orgTable" class="easyui-treegrid">
		<thead>
			<tr>
				<th data-options="field:'id'" hidden="true">部门Id</th>
				<th data-options="field:'supOrgID'" hidden="true">上级机构的Id</th>
				<th data-options="field:'text',width:100">部门名称</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding: 10px 20px"
		...
		<form id="fm" method="post" novalidate>
			<input name="Id" id="orgId" hidden="true" />
			<div class="fitem">
				<label>部门名称:</label>
			...
			<div class="fitem">
				<label>上级部门:</label>
				<input name="supOrgId" id="supOrgID" class="easyui-combobox">
			</div>
			<div class="fitem">
				<label>排序号:</label>
